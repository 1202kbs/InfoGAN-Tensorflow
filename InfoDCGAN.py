...
class InfoDCGAN(object):
    ...
    def build_generator(self):
        ...
        G_layer3 = tf.nn.conv2d_transpose(G_layer2, self.G_W3, [tf.shape(G_layer2)[0], 14, 14, 64], [1, 2, 2, 1], 'SAME')
    ...
    def build_model(self):
        ...
        self.var_list = {'G_W1': self.G_W1, 'G_W2': self.G_W2, 'G_W3': self.G_W3, 'G_W4': self.G_W4, 'G_b1': self.G_b1, 'G_b2': self.G_b2, \
                         'D_W1': self.D_W1, 'D_W2': self.D_W2, 'D_W3': self.D_W3, 'D_W4': self.D_W4, 'D_b3': self.D_b3, 'D_b4': self.D_b4, \
